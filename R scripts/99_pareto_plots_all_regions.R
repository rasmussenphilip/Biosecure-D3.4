...
# ============================================================
# 15b_pareto_all_regions_herd_type_plots.R
# Standalone all-regions Naive/Average/Infected 3D Pareto plots
# ============================================================

out_dir <- "exports"
plot_dir <- file.path(out_dir, "pareto_3d_plots_all_regions_herd_type")
...
# ============================================================
# Keep only all-regions Naive/Average/Infected contexts
# ============================================================
